<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex flex-col items-center justify-end mt-4">
            ...
            <x-primary-button class="mr-2 -ml-1 w-4 h-4"
                class="text-white w-full  bg-[#ffffff] hover:bg-[#fffffe]/90 focus:ring-4 focus:outline-none focus:ring-[#fffffe]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
                {{ __('Log in') }}
            </x-primary-button>
        </div>
        <div class="px-6 sm:px-0 max-w-sm">
            <button type="button"
                ...
                </svg><a href="{{ URL::to('auth/google') }}">Sign up with Google<div></div></a>
            </button>
        </div>
    </form>
</x-guest-layout>
